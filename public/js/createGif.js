...
var rnfn;
var main_interval = setInterval(switcher,3*1000);
function switcher(){
  ...
  if(type+1>0){
    ...
    temp.getBase64GIF(function(image) {
...
function run(){
  ag = new Animated_GIF({ workerPath: '/third-party/Animated_GIF_Worker.js' });
  ag.setSize(r*2, r*2);
  ...
  draw_interval = setInterval(function(){
    ag.addFrameImageData(ctx.getImageData(0, 0, r*2, r*2));
    rnfn();
  },10);
}
